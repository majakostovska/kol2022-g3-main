...
public class ForumUsersController {
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        model.addAttribute("user",this.forumUserService.findById(id));
        model.addAttribute("interests",this.interestService.listAll());
        model.addAttribute("types", ForumUserType.values());
        return "form";
    }
    ...
    public String create(@RequestParam String name,
        ...
        this.forumUserService.create(name, email, password, type, interestId, LocalDate.parse(birthday));
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam List<Long> interestId,
                         @RequestParam String birthday) {
        this.forumUserService.update(id, name, email, password, type, interestId, LocalDate.parse(birthday));
        return "redirect:/users";
    }
